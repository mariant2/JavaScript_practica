...
//Required the data of the students
let name = prompt("Name of the student: ")
let examScores = prompt("Put a numeric grade here: ")
let age = prompt("Age of the student: ")
let gender = prompt("The gender should be male or female, please: ")
var examInt = parseInt(examScores);
